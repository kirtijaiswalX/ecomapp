...
class Product(models.Model):
    ...
    description = models.TexxtField(null=True,blank=True)
    rating = models.DecimmalField(max_digits=12,decimal_places=2,null=True,blank=True)
...
class Review(models.Model):
    ...
    user = models.ForeignKey(User,on_delete=models.Set_null,null=True,bank=True)
    name = models.CharField(max_length=200,null=True,blank=True)
...
class OrderItem(models.Model):
    ...
    price = models.DecimalField(max_digits=12,decimal_place=2,null=True,blank=True)
